...
uses
  ...
  CadProdutos, CadUsuarios, Orcamentos, Sobre, RelMod, relprod, RelOrc, RelCat;
...
type
  ...
  TMenuPrincipalF = class(TForm)
    ...
    procedure MnRCategoriaClick(Sender: TObject);
...
procedure TMenuPrincipalF.MnRCategoriaClick(Sender: TObject);
begin
